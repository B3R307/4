...
//variable de resultado
  ...
  var element = obj.element
    // console.log(element);
  // acceder a una propiedad del objeto objeto.nombre dela propiedad
  ...
  var  classN = obj.classNames
    ...
    onlyHtml = `<${element} class="${classN}">${text}</${element}>`
        //
        // console.log(onlyHtml);
        // console.log(typeof onlyHtml);
        return onlyHtml
